...
class MainWindow(CTk):
    def __init__(self,socket,username):     
        ...
        # Меню
        self.label = None
        self.menu_frame = CTkFrame(self, width=30, height=300,fg_color="gray")
        ...
        self.message_entry = CTkEntry(self, placeholder_text='Введіть повідомлення:', height=40,fg_color="gray")
            ...
            if len(parts) ==3:
                ...
                if len(parts) >= 4:
                    ...
                    try:
                        ...
                        pil_img = Image.open(io.bitesIO(img_data))
                        ctk_image = CTkImage(pil_img, size=(300,300))
                        self.add_message(f"{author} надіслав(ла) зображення:{filename}",img=ctk_image)
    ...
    def open_image(self):
        ...
        try:
            ...
            data = f"IMAGE@{self.user_name}@{short_name}@{b64_data}\n"
            self.sock.sendall(data.encode())
